...
async function q(a, e) {
  ...
  }, n = e ? e(r) : r, c = D() ? s.body : await s.blob();
...
class K {
  ...
  handleAll(e) {
    ...
    const t = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, r = "params" in e ? e.params : void 0, n = new V(this, { event: t, request: s, params: r }), c = this._getResponse(n, s, t), i = this._awaitComplete(c, n, s, t);
    return [c, i];
  }
...
se([{"revision":null,"url":"assets/index-NMActKzB.js"},{"revision":null,"url":"assets/index-NNiAbaVx.css"},{"revision":"a3527421fd42dec828d7a221eac87512","url":"fonts.css"},{"revision":"e1b2eb57029793ebf51091a5ab9672e4","url":"index.html"},{"revision":"363f818bb024e39ec8f7952f470f4edd","url":"registerSW.js"},{"revision":"e1f75d9f283a3a996747a1ad6ce0a0fc","url":"manifest.webmanifest"}]);
